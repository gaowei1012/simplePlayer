    ...
    _renderHeader = () => {
        ...
        return (
            <View style={styles.topBarBox}>
                {area.map((a) => {
                    return (
                        <TouchableOpacity activeOpacity={1} onPress={() => this.switchTab(a.type, a.name)} key={a.id}>
                            <Text style={[this.state.top_menu === a.type ? styles.actionText : styles.noActionText]}>
                                {a.name}
                            </Text>
                    ...
                    return (
                        <TouchableOpacity
                            ...
                            <View style={styles.videoBtnBox}>
                                <Text numberOfLines={1} style={{marginRight: px2dp(4), fontSize: 16}}>
                                    {item.name}
                                </Text>
                                <Text>-</Text>
                                <Text
    ...
    render() {
        return (
            <SafeAreaView style={styles.container}>
                {/* {this._renderTopBar()} */}
                {this._renderHeader()}
                <ScrollView style={{marginTop: px2dp(10)}}>{this._switchContent()}</ScrollView>
            </SafeAreaView>
        );
    }
}
