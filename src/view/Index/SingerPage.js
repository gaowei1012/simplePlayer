...
class SingerPage extends React.Component {
    ...
    _renderTopBar = () => {
        return (
            <ImageBackground style={styles.topHeaderBox} source={require('../../images/common/bg.jpg')}>
    ...
    _renderItem(data) {
        ...
        return (
            <>
                <TouchableOpacity
                    activeOpacity={1}
                    onPress={() => NavigationUtil.goPage({item}, 'Player')}
                    style={styles.personalBox}>
    ...
    _renderList = () => {
        ...
        return <FlatList data={personaliz} renderItem={this._renderItem} />;
    };
    // 全部播放
    allPlayper = () => {
        return (
            <View style={styles.contentTopBox}>
                <TouchableOpacity
                    ...
                    <Image
                        style={{width: px2dp(18), height: px2dp(18), marginRight: px2dp(3)}}
                        source={require('../../images/player.png')}
                    />
                    <Text style={styles.textDesc}>全部播放</Text>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={1} onPress={() => Toast.showToast('功能开发中')}>
