...
import {View, Text, StyleSheet, SafeAreaView, Slider, Image, TouchableOpacity, ScrollView, Alert} from 'react-native';
import {flex, row, center, spaceBetween, defaultFontSize} from '../styles/constants';
    ...
    _rightElm = () => {
        return (
            <TouchableOpacity onPress={this.handleShare} style={styles.topRightBox}>
                <Image style={styles.shareIcon} source={require('../images/common/share.png')} />
            </TouchableOpacity>
        );
    };
    ...
    _switch = () => {
        return (
            <View style={styles.switchBox}>
                <TouchableOpacity>
                    <Image style={styles.likeIcon} source={require('../images/common/like.png')} />
                </TouchableOpacity>
                <TouchableOpacity>
                    <Image style={styles.nextIcon} source={require('../images/common/on.png')} />
                </TouchableOpacity>
                <TouchableOpacity onPress={this.handleCheck} style={styles.onOfoFF}>
                    {this.state.checkPlayer ? (
                        <Image style={styles.muiscPlayer} source={require('../images/common/music_player.png')} />
                    ) : (
                        <Image style={styles.muiscPlayer} source={require('../images/common/stop.png')} />
                    )}
                </TouchableOpacity>
                <TouchableOpacity>
                    <Image style={styles.nextIcon} source={require('../images/common/next.png')} />
                </TouchableOpacity>
                <TouchableOpacity>
                    <Image style={styles.nextIcon} source={require('../images/common/list.png')} />
                </TouchableOpacity>
            </View>
        );
    };
